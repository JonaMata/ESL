...
## Encoder IP
## Version: 1.0
## Creator: Joep Meussen & Jonathan Matarazzi
...
## IP details
##  
set_module_property DESCRIPTION "JIWY IP (Avalon-MM slave port)"
set_module_property NAME jiwy
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR Meussen&Matarazzi
set_module_property DISPLAY_NAME jiwy
set_module_property TOP_LEVEL_HDL_FILE jiwy.v
set_module_property TOP_LEVEL_HDL_MODULE jiwy
...
##  
add_file jiwy.v {SYNTHESIS SIMULATION}
...
add_parameter PWM_WIDTH int 8 "PWM width"
set_parameter_property PWM_WIDTH DISPLAY_NAME "PWM Width"
set_parameter_property PWM_WIDTH GROUP "PWM Properties"
set_parameter_property PWM_WIDTH AFFECTS_PORT_WIDTHS true
set_parameter_property PWM_WIDTH ALLOWED_RANGES {8}

add_parameter PWM_KHZ int 20 "PWM frequency in kHz"
set_parameter_property PWM_KHZ DISPLAY_NAME "PWM Frequency (kHz)"
set_parameter_property PWM_KHZ GROUP "PWM Properties"
set_parameter_property PWM_KHZ AFFECTS_PORT_WIDTHS true
set_parameter_property PWM_KHZ ALLOWED_RANGES {1 2 5 10 20 50 100}
...
add_interface_port user_interface enc_yaw export Input 2
add_interface_port user_interface enc_pitch export Input 2
add_interface_port user_interface motor_yaw export Output 3
add_interface_port user_interface motor_pitch export Output 3

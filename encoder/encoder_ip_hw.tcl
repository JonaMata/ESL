...
## IP details
##  
set_module_property DESCRIPTION "Encoder IP (Avalon-MM slave port)"
set_module_property NAME encoder_ip
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR Meussen&Matarazzi
set_module_property DISPLAY_NAME encoder_ip
set_module_property TOP_LEVEL_HDL_FILE encoder_ip.v
set_module_property TOP_LEVEL_HDL_MODULE encoder_ip
...
add_file encoder_ip.v {SYNTHESIS SIMULATION}
...
add_interface_port user_interface a_channel export Input 1
add_interface_port user_interface b_channel export Input 1

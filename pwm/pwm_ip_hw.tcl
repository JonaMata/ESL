...
set_module_property TOP_LEVEL_HDL_FILE pwm_ip.v
set_module_property TOP_LEVEL_HDL_MODULE pwm_ip
...
add_file pwm_ip.v {SYNTHESIS SIMULATION}
...
add_interface_port user_interface ina export Output 1
add_interface_port user_interface inb export Output 1
add_interface_port user_interface pwm_out export Output 8
